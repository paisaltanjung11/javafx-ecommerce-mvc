...
public class UpdateDeliveryStatusView {
            ...
            for (Delivery delivery : deliveries) {
                ...
                if (order != null) {
                    ...
                    updateBtn.setOnAction(e -> {
                        stage.close();
                        DeliveryStatusSelectionView deliveryStatusSelectionView = new DeliveryStatusSelectionView();
                        deliveryStatusSelectionView.show(delivery);
                    });
